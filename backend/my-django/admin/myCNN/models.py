...
class Cifor10Classification(object):
    def __init__(self):
        self.vo = ValueObject()
        self.vo.context = 'admin/myCNN/data/'
    ...
    def process(self):
        ...
        # plt.show()
        plt.savefig(f'{self.vo.context}Cifor10Classification.csv')
    ...
    def build_CNN_classifier(self, x, keep_prob=None):
        # 입력이미지
        x_image = x
...
class CatDogClassification(object):
    ...
    def process(self):
        ...
        plt.savefig(f'{self.vo.context}CatDogClassification.csv')
